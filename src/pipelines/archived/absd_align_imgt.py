...
requirements:
    ...
    - igblastp ready
example:
    - parallel -j8 python src/pipelines/absd_align_imgt.py ::: {0..460}
    - python src/pipelines/absd_align_imgt.py 0
function:
    - build table pdb and insert data into table absd_align_imgt
'''
